...
namespace engine
{
    ...
    void Engine::render(EngineArgs& args)
    {
        ...
        //Shadows
        const std::vector<Entity*> dir_lights = project_->current_scene->get_lights_by_type(lights::LIGHT_TYPE::DIRECTIONAL);
    ...
    void Engine::set_hardcoded_entities(Scene& scene)
    {
        ...
        dir_light->add_component<LightComponent>(lights::LIGHT_TYPE::DIRECTIONAL, glm::vec3(1.0f), 5.0f);
        ...
        point_light->add_component<LightComponent>(lights::LIGHT_TYPE::POINT, glm::vec3(1.0f, 1.0f, 0.0f), 0.5f);
        ...
        point_light_2->add_component<LightComponent>(lights::LIGHT_TYPE::POINT, glm::vec3(1.0f, 1.0f, 1.0f), 1.0f);
